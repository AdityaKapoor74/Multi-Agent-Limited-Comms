...
# "tj-hard-best-config"/ "tj-hard-ddcl-config"/ "tj-hard-fakequant-config"/ "tj-hard-delta-config"
EXPERIMENT_NAME="tj-hard-fakequant-config"
NUM_AGENTS=5
